I. Installing Vanir Windows Tools
=================================

Vanir Windows Tools are currently supported on 64-bit Windows (7 or
...
Installing Vanir Windows Tools
------------------------------
...
* In some situations, you might be prompted to format a "Vanir Private
...
1) The Xen PV disk driver is disabled by default. This is because it causes
   a BSOD after installation in Vanir. However, it seems to work fine after
